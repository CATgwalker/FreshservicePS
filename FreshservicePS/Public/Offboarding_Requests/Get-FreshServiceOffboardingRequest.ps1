<#
.SYNOPSIS
    Returns a Freshservice Offboarding Request.

.DESCRIPTION
    Returns a Freshservice Offboarding Request via REST API.

    https://api.freshservice.com/#create_offboarding_request

.PARAMETER id
    Unique id of the Offboarding Request.

.PARAMETER tickets
    Retrieve and view the Offboarding Tickets associated with an Offboarding Request.

.PARAMETER fields
    Allows you to view all the built-in and custom fields for the Offboarding Request in your Freshservice account.
...
.EXAMPLE
    Get-FreshserviceOffboardingRequest
    ...
    Returns all FreshService Offboarding Requests.

.EXAMPLE
    Get-FreshserviceOffboardingRequest -id 1
    ...
    Returns a specific FreshService Offboarding Request by id.

.EXAMPLE
    Get-FreshserviceOffboardingRequest -id 1 -tickets
    ...
    Returns tickets associated with a specific FreshService Offboarding Request by id.

.EXAMPLE
    Get-FreshServiceOffboardingRequest -fields
    ...
    Returns all the built-in and custom fields for the Offboarding Request.
.NOTES
    This module was developed and tested with Freshservice REST API v2.
#>
function Get-FreshServiceOffboardingRequest {
    [CmdletBinding(DefaultParameterSetName = 'default')]
    param (
        [Parameter(
            Mandatory = $true,
            HelpMessage = 'Unique id of the Offboarding Request.',
            ParameterSetName = 'id',
            Position = 0
        )]
        [Parameter(
        ...
        [Parameter(
            Mandatory = $true,
            HelpMessage = 'Retrieve and view the Offboarding Tickets associated with an Offboarding Request.',
            ParameterSetName = 'Ticket',
            Position = 1
        )]
        [switch]$tickets,
        [Parameter(
            Mandatory = $false,
            HelpMessage = 'Allows you to view all the built-in and custom fields for the Offboarding Request in your Freshservice account.',
